...
void setup() {
  ...
  Serial.begin(115200); // Initializes Serial Monitor for viewing data via USB on the computer
...
void loop() {
  ...
  if (Break_event.light > 800) 
  {
    ...
    Serial.println("Break light is on!");
    Serial.print("luminosity_Break From Break Light: ");                        
    Serial.print(Break_light_string);                           
    Serial.println(" lux");                            
  }
  else{
  ...
  {  
    ...
    Serial.println("Right light is on!");
    Serial.print("luminosity_Right From Right Light: ");                        
    Serial.print(Right_light_string);                           
    Serial.println(" lux");                                               
  }
  if (Left_event.light > 800) 
  {
    ...
    Serial.println("Left light is on!");
    Serial.print("luminosity_Left From Left Light: ");                        
    Serial.print(Left_light_string);                           
    Serial.println(" lux");                                                             
  }
  delay(10);  
  //} 
